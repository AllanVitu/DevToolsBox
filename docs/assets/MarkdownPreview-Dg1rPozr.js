import{_ as p,o as d,c as h,w as f,a as r,f as g,v as m,u as _,A as $,d as v}from"./index-BQU7vMij.js";import{T as w}from"./ToolShell-xGivYxzc.js";import{u as b}from"./usePersistentRef-BMxX2n6D.js";function k(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(a){return a.replace(/\[([^\]]+)\]\(([^)\s]+)\)/g,'<a href="$2" target="_blank" rel="noopener">$1</a>').replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,"<code>$1</code>")}function j(a){const t=k(a).split(`
...
`)}const x={class:"split"},M={class:"field pane"},T={class:"field pane"},P=["innerHTML"],U={__name:"MarkdownPreview",setup(a){const t=b("md:input",`# Titre
...
[Un lien](https://vuejs.org)`),l=v(()=>j(t.value));return(e,n)=>(d(),h(w,{title:"Aperçu Markdown",icon:"M↓",desc:"Écris à gauche, vois le rendu à droite."},{default:f(()=>[r("div",x,[r("div",M,[n[1]||(n[1]=r("label",null,"Markdown",-1)),g(r("textarea",{"onUpdate:modelValue":n[0]||(n[0]=o=>$(t)?t.value=o:null),spellcheck:"false"},null,512),[[m,_(t)]])]),r("div",T,[n[2]||(n[2]=r("label",null,"Aperçu",-1)),r("div",{class:"md-body",innerHTML:l.value},null,8,P)])])]),_:1}))}},H=p(U,[["__scopeId","data-v-e0161cd5"]]);export{H as default};
