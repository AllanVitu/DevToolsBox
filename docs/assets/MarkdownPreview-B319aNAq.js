import{_ as p,o as d,p as h,i as f,a as r,D as g,E as m,u as _,K as $,k as v}from"./index-lYx7tp1z.js";import{T as w}from"./ToolShell-V0p4slg7.js";import{u as k}from"./usePersistentRef-Bx4vze1_.js";function b(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(a){return a.replace(/\[([^\]]+)\]\(([^)\s]+)\)/g,'<a href="$2" target="_blank" rel="noopener">$1</a>').replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,"<code>$1</code>")}function j(a){const t=b(a).split(`
...
[Un lien](https://vuejs.org)`),l=v(()=>j(t.value));return(e,n)=>(d(),h(w,{title:"Aperçu Markdown",icon:"M↓",desc:"Écris à gauche, vois le rendu à droite."},{default:f(()=>[r("div",x,[r("div",M,[n[1]||(n[1]=r("label",null,"Markdown",-1)),g(r("textarea",{"onUpdate:modelValue":n[0]||(n[0]=i=>$(t)?t.value=i:null),spellcheck:"false"},null,512),[[m,_(t)]])]),r("div",T,[n[2]||(n[2]=r("label",null,"Aperçu",-1)),r("div",{class:"md-body",innerHTML:l.value},null,8,P)])])]),_:1}))}},H=p(U,[["__scopeId","data-v-e0161cd5"]]);export{H as default};
